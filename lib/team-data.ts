...
export const devPods: DevPod[] = [
  ...
  },
  {
    ...
    name: "FPL POD",
    valueStream: "Release",
    description: "FPL-specific programs across preferences, name change, FPLES, DSM, dev, and billing",
    color: "from-cyan-500/20 to-cyan-500/5",
    release: "IR3.2",
    badges: ["Preferences", "Name Change", "FPLES", "DSM", "Dev Programs", "Billing Programs"],
    team: [
      { name: "Sona Muthayala", role: "Dev", status: "Active", valueStreams: ["Preferences", "FPLES Programs"] },
