...
export const leadershipTeam: LeadershipMember[] = [
  ...
  { name: "Tim Watt", role: "Lead", status: "Active" },
...
export const devPods: DevPod[] = [
  ...
  },
  {
    ...
    team: [
      { name: "Shreya LNU", role: "Lead", status: "Active" },
      { name: "Jyoti Kumari", role: "Lead", status: "Active" },
  ...
  },
  {
    ...
    team: [
      ...
      { name: "Bhyravabhotla Naga Lakshmi Sirisha", role: "Offshore Solution Analyst", status: "Active" },
...
export const sitUatExecutionTeam: SitUatMember[] = [
  ...
  { name: "Lovely Kumari", role: "QA", status: "Active", valueStreams: ["All Value Streams"] },
];
...
export const crossFunctionalTeams: CrossFunctionalTeam[] = [
  ...
  },
  {
    ...
    team: [
      ...
      { name: "Suraje V", role: "Team", status: "Active" },
    ],
  },
  {
    id: "cf-windsurf",
    ...
    team: [
      ...
      { name: "Sanniboina Murali Krishna", role: "Team", status: "Active" },
    ],
  },
  {
    id: "cf-interns",
